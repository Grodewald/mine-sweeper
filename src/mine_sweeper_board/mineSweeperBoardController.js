/*global define */
define([ 'globalEvents', 'mine_sweeper_board/boardEvents'],
    function(globalEvents, boardEvents) {
        'use strict';

        return ['$scope', '$rootScope', 'bombFactory', 'boardFactory',
        function($scope, $rootScope, bombFactory, boardFactory) {
